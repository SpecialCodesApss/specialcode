...
<div class="pcoded-inner-content">
    ...
    <div class="wrapper_cols">
        <div class="col_page_content">
            ...
            href="{{ route('notifications_texts.create') }}">
  {{trans('admin.Create')}} </a> <br> <br>
                        ...
                        <div class="blog_tablesearch">
                            <div >
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("notifications_texts.id")}}</th>
                          <th class="is_filter">{{trans("notifications_texts.description_text_en")}}</th>
                          <th class="is_filter">{{trans("notifications_texts.description_text_ar")}}</th>
                          <th class="is_filter">{{trans("notifications_texts.trarget_url")}}</th>
                          <th class="is_filter">{{trans("notifications_texts.icon")}}</th>
            ...
            {extend:'csvHtml5',text:"{{trans("admin.csvHtml5")}}",
             ...
             {extend:'print',text:"{{trans("admin.print")}}" ,
                                ...
                                ajax: "{{ route('notifications_texts.index') }}",
                                aoColumns: [
                                    {data: 'id', name: 'id'},
                    {data: 'description_text_en', name: 'description_text_en'},
                    {data: 'description_text_ar', name: 'description_text_ar'},

                    {data: 'trarget_url', name: 'trarget_url',
