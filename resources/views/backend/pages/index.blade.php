        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-left">
{{--                        <a class="btn btn-success" href="{{ route('pages.create') }}"> إضافة جديد </a>--}}
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("pages.page_key")}}</th><th class="is_filter">{{trans("pages.title_ar")}}</th><th class="is_filter">{{trans("pages.title_en")}}</th><th width="100px">تحكم</th>
                                    </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var table = $('.dataTable').DataTable({
                                ...
                                aoColumns: [
                                    {data: 'page_key', name: 'page_key'},{data: 'title_ar', name: 'title_ar'},{data: 'title_en', name: 'title_en'}, {data: 'action', name: 'action', orderable: false,
                                        paging:false,
                                        searchable: false,
                                        bSearchable:false,
                                    },
