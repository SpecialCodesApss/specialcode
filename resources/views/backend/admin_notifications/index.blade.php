                        ...
                        <div class="blog_tablesearch">
                            <div >
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("admin_notifications.id")}}</th>
                          <th class="is_filter">{{trans("admin_notifications.notification_id")}}</th>
...
{{--                          <th class="is_filter">{{trans("admin_notifications.is_marked_as_deleted")}}</th>--}}
            ...
            {extend:'csvHtml5',text:"{{trans("admin_messages.csvHtml5")}}",
             ...
             {extend:'print',text:"{{trans("admin_messages.print")}}" ,
                    ...
                    {data: 'is_marked_as_readed', name: 'is_marked_as_readed'},
                    // {data: 'is_marked_as_deleted', name: 'is_marked_as_deleted'},
