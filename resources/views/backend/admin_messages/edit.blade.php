...
<div class="pcoded-inner-content">
    ...
    {!! Form::model($Admin_message, ['method' => 'PATCH','enctype'=>'multipart/form-data','route' => ['admin_messages.update', $Admin_message->id]]) !!}
    <div class="row">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                {!!Form::select('user_id', $users, $Admin_message->user_id, ['class' => 'form-control  chosen-select'])!!}
                            </div>
                        </div>
