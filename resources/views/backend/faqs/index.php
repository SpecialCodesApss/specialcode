                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">question</th><br><th class="is_filter">answer</th><br><th class="is_filter">active</th><br><th class="is_filter">store</th><br><th width="100px">تحكم</th>
                                    </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var table = $('.dataTable').DataTable({
                                ...
                                aoColumns: [
                                    {data: 'question', name: 'question'}{data: 'answer', name: 'answer'}{data: 'active', name: 'active'}{data: 'store', name: 'store'} {data: 'action', name: 'action', orderable: false,
                                        paging:false,
                                        searchable: false,
                                        bSearchable:false,
                                    },
