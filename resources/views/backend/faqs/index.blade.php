        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-left">
                        <a class="btn btn-success" href="{{ route('faqs.create') }}"> إضافة جديد </a>
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("faqs.question_ar")}}</th><th class="is_filter">{{trans("faqs.question_en")}}</th><th class="is_filter">{{trans("faqs.active")}}</th><th class="is_filter">{{trans("faqs.sort")}}</th><th width="100px">تحكم</th>
                                    </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var table = $('.dataTable').DataTable({
                                ...
                                aoColumns: [
                                    {data: 'question_ar', name: 'question_ar'},{data: 'question_en', name: 'question_en'},{data: 'active', name: 'active'},{data: 'sort', name: 'sort'}, {data: 'action', name: 'action', orderable: false,
                                        paging:false,
                                        searchable: false,
                                        bSearchable:false,
                                    },
