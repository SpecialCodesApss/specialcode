...
<div>{{$Test->number}}</div>                        </div>
                       ...
                       <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                @if(isset($Test->image))
                                    <img class="img-responsive" src="{{url($Test->image)}}" alt="">
                                @endif
                                </div>
                               </div>
                        </div>
             ...
             <div class="col-xs-3 col-sm-3 col-md-3">
                     ...
                     <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                            <strong>{{trans("tests.created_at")}}   {{trans("admin_messages.time")}}  :</strong>
             ...
             <div class="col-xs-3 col-sm-3 col-md-3">
                     ...
                     <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                            <strong>{{trans("tests.updated_at")}}   {{trans("admin_messages.time")}}  :</strong>
