...
@section('title',trans('admin_messages.admin_messages'))
@section('header')
@endsection
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{trans('admin_messages.admin_messages')}}</h5>
...
<div class="pcoded-inner-content">
    ...
    <div class="col-lg-12">
        ...
        <div class="align_btn_end">
                <a class="btn btn-primary" href="{{ url('admin_messages') }}">
                {{trans('admin.back')}}</a>
            </div>
        </div>
    ...
    {!! Form::model($Admin_message, ['method' => 'PATCH','enctype'=>'multipart/form-data','url' => ['admin_messages', $Admin_message->id]]) !!}
    <div class="row">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('fullname', $Admin_message->fullname, array('placeholder' => trans("admin_messages.fullname"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('email', $Admin_message->email, array('placeholder' => trans("admin_messages.email"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('mobile', $Admin_message->mobile, array('placeholder' => trans("admin_messages.mobile"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        @if(old('message_type')=="Complaint")!=null)
                            ...
                            @endif
                        @else
                            @if($Admin_message->message_type=="Complaint")
                            selected
                            @endif
                        @endif
                        ...
                        @if(old('message_type')=="Suggestion")!=null)
                            ...
                            @endif
                        @else
                            @if($Admin_message->message_type=="Suggestion")
                            selected
                            @endif
                        @endif
                        ...
                        @if(old('message_type')=="Technical Support")!=null)
                            ...
                            @endif
                        @else
                            @if($Admin_message->message_type=="Technical Support")
                            selected
                            @endif
                        @endif
                        ...
                        @if(old('message_type')=="Management")!=null)
                            ...
                            @endif
                        @else
                            @if($Admin_message->message_type=="Management")
                            selected
                            @endif
                        @endif
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 nopadding">
                            ...
                            <br>
                             ...
                             @if(isset($Admin_message->image))
                                <img  src="{{url($Admin_message->image)}}"  class="uploaded_image"
                ...
                {{trans('admin.Upload')}}
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('messages_text',$Admin_message->messages_text, array('placeholder' => trans("admin_messages.messages_text"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        @if(old('open_status')=="Open")!=null)
                            ...
                            @endif
                        @else
                            @if($Admin_message->open_status=="Open")
                            selected
                            @endif
                        @endif
                        ...
                        @if(old('open_status')=="Closed")!=null)
                            ...
                            @endif
                        @else
                            @if($Admin_message->open_status=="Closed")
                            selected
                            @endif
                        @endif
