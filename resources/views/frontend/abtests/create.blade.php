...
<div class="pcoded-inner-content">
    ...
    {!! Form::open(array('enctype'=>'multipart/form-data','url' => 'abtests','method'=>'POST','id'=>'form')) !!}
    ...
    <div class="row">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name_ar', "", array('placeholder' => trans("abtests.name_ar"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name_en', "", array('placeholder' => trans("abtests.name_en"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('number', "", array('placeholder' => trans("abtests.number"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                 ...
                 <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::number('sort',$sort_number, array('placeholder' => trans("abtests.sort"),'class' => 'form-control')) !!}
                            </div>
                        </div>
