...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) { // jshint ignore:line
        ...
        define(['resources/admin/assets/js/jquery'], factory); // jshint ignore:line
    } else { // noinspection JSUnresolvedVariable
        if (typeof module === 'object' && module.exports) { // jshint ignore:line
            // Node/CommonJS
            // noinspection JSUnresolvedVariable
            module.exports = factory(require('resources/admin/assets/js/jquery')); // jshint ignore:line
        } else {
            // Browser globals
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-sm btn-kv btn-danger btn-outline-secondary',
                    ...
                    dragSettings: {},
                    indicatorNew: '<i class="fa fa-plus-sign text-primary"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        cancelLabel: 'إلغاء',
        cancelTitle: 'إلغاء التحميل',
        uploadLabel: 'رفع',
        uploadTitle: 'تحميل الملفات المحددة',
        msgNo: 'لا',
        msgNoFilesSelected: 'لا توجد ملفات محددة',
        msgCancelled: 'تم الإلغاء',
        msgPlaceholder: 'إختر الملفات...',
