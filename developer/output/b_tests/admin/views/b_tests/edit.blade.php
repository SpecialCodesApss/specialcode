...
@section('content')
    ...
    @endif
    {!! Form::model($B_test, ['method' => 'PATCH','enctype'=>'multipart/form-data','route' => ['b_tests.update', $B_test->id]]) !!}
    <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input id="users_ids" name="users_ids" type="text" value="{{$B_test->users_ids}}">
                 ...
                 <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::number('pages_id',$B_test->pages_id, array('placeholder' => trans("b_tests.pages_id"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input id="table_ids" name="table_ids" type="text" value="{{$B_test->table_ids}}">
                            <script type="text/javascript">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('test_2', $B_test->test_2, array('placeholder' => trans("b_tests.test_2"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('email',$B_test->email, array('placeholder' => trans("b_tests.email"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('type', $B_test->type, array('placeholder' => trans("b_tests.type"),'class' => 'form-control')) !!}
                        </div>
                    </div>
