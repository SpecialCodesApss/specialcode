        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-left">
                        <a class="btn btn-success" href="{{ route('b_tests.create') }}"> إضافة جديد </a>
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("b_tests.id")}}</th>
                          <th class="is_filter">{{trans("b_tests.pages_id")}}</th>
                          <th class="is_filter">{{trans("b_tests.test_2")}}</th>
                          <th class="is_filter">{{trans("b_tests.email")}}</th>
                          <th class="is_filter">{{trans("b_tests.image")}}</th>
                          <th class="is_filter">{{trans("b_tests.type")}}</th>
            ...
            {extend:'csvHtml5',text:'تصدير CSV',
             ...
             {extend:'print',text:'طباعة' ,
                                ...
                                ajax: "{{ route('b_tests.index') }}",
                                aoColumns: [
                                    {data: 'id', name: 'id'},
                    {data: 'pages_id', name: 'pages_id'},
                    {data: 'test_2', name: 'test_2'},
