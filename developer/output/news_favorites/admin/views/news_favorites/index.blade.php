        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right">
                        <h5>الأخبار المفضلة</h5>
                    </div>
                    <div class="pull-left">
                        <a class="btn btn-success" href="{{ route('news_favorites.create') }}"> إضافة جديد </a>
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("news_favorites.id")}}</th>
                          <th class="is_filter">{{trans("news_favorites.news_id")}}</th>
                          <th class="is_filter">{{trans("news_favorites.user_id")}}</th>
            ...
            {extend:'csvHtml5',text:'تصدير CSV',
             ...
             {extend:'print',text:'طباعة' ,
                                ...
                                ajax: "{{ route('news_favorites.index') }}",
                                aoColumns: [
                                    {data: 'id', name: 'id'},
