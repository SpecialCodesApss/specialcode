...
@section('content')
    ...
    @endif
    {!! Form::model($News_comment, ['method' => 'PATCH','enctype'=>'multipart/form-data','route' => ['news_comments.update', $News_comment->id]]) !!}
    <div class="row">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                {!!Form::select('user_id', $users, $News_comment->user_id, ['class' => 'form-control  chosen-select'])!!}
                            </div>
                        </div>
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('comment_text',$News_comment->comment_text, array('placeholder' => trans("news_comments.comment_text"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input id="users_likes_ids" name="users_likes_ids" type="text" value="{{$News_comment->users_likes_ids}}">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input id="users_dislikes_ids" name="users_dislikes_ids" type="text" value="{{$News_comment->users_dislikes_ids}}">
                            <script type="text/javascript">
                                users_autoComplete = [];
                                $(function() {
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="box">
                            ...
                            <select class="wide" id="active" name="active">
                                <option value="1" @if($News_comment->active=="1") selected @endif>مفعل</option>
                                <option value="0" @if($News_comment->active!="1") selected @endif>غير مفعل</option>
                            </select>
                        </div>
                        <script>
