import '../../Controllers/News_categorieController.dart';
import 'package:flutter/cupertino.dart';
import '../../helpers/LoaderDialog.dart';
import '../../helpers/ToastHelper.dart';
import 'package:framework_01_6/helpers/LanguageHelper.dart' as LanguageHelper;
import '../../lang/ar/news_categories.dart' as messages_ar;
import '../../lang/en/news_categories.dart' as messages_en;
import '../../main.dart';
...
class News_categoriesIndex extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _News_categoriesIndexState();
  }
}

class _News_categoriesIndexState extends State<News_categoriesIndex>{
  ...
  String viewType = "ListView";
    ...
    int pagesCount = 1 ;
    int newPage = 2;
  News_categorieController _News_categorieController = new News_categorieController();
  ...
  RefreshController _refreshController =
    ...
    void _onRefresh() async {
      ...
      //get list data
            _News_categorieController.index(1,searchText).whenComplete((){
              if(_News_categorieController.status == true){
                setState(() {
                  data = _News_categorieController.listData;
                  if(data.length > 0){
                    isNoListData=false;
                    pagesCount = _News_categorieController.data["data"]["last_page"];
                  }
                });
              }else{
                ShowToast("warning",_News_categorieController.message);
              }
            });
    ...
    void _onLoading() async {
      ...
      if (mounted)
        _News_categorieController.index(newPage,searchText).whenComplete((){
          if(_News_categorieController.status == true){
            setState(() {
              data.addAll(_News_categorieController.listData);
              newPage++;
            });
          }
          else{
    ...
    return Scaffold(
      appBar: ViewSearchBar==true ?
            SearchAppBar(
              ...
              mainAppBar: AppBar(
                title: Text(
                language =="en" ? messages_en.getTranslation("News_categories") : messages_ar.getTranslation
                              ("News_categories"),
                                    ...
                                    child:  Column(
                                      ...
                                      children: <Widget>[
                                        FadeInImage.assetNetwork(
                                          ...
                                          image:"http://192.168.0.101/framework/"+data[index]["category_image"] ,
                                          width: 40.0 ,
                                          height: 40.0 ,
                                        ),
                                        Padding(
