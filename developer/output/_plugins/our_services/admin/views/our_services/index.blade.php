        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-left">
                        <a class="btn btn-success" href="{{ route('our_services.create') }}"> إضافة جديد </a>
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("our_services.id")}}</th>
                          <th class="is_filter">{{trans("our_services.name_ar")}}</th>
                          <th class="is_filter">{{trans("our_services.name_en")}}</th>
                          <th class="is_filter">{{trans("our_services.image")}}</th>
                          <th class="is_filter">{{trans("our_services.active")}}</th>
