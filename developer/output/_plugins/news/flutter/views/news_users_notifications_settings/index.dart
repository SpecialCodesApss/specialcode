...
class News_users_notifications_settingsIndex extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _News_users_notifications_settingsIndexState();
  }
}

class _News_users_notifications_settingsIndexState extends State<News_users_notifications_settingsIndex>{
  ...
  RefreshController _refreshController =
    ...
    void _onRefresh() async {
      ...
      //get list data
            _News_users_notifications_settingController.index(1,searchText).whenComplete((){
              if(_News_users_notifications_settingController.status == true){
                setState(() {
                  data = _News_users_notifications_settingController.listData;
                  if(data.length > 0){
                    isNoListData=false;
                    pagesCount = _News_users_notifications_settingController.data["data"]["last_page"];
                  }
                });
              }else{
    ...
    void _onLoading() async {
      ...
      if (mounted)
        _News_users_notifications_settingController.index(newPage,searchText).whenComplete((){
          if(_News_users_notifications_settingController.status == true){
            setState(() {
              data.addAll(_News_users_notifications_settingController.listData);
              newPage++;
            });
          }
          else{
    ...
    return Scaffold(
      appBar: ViewSearchBar==true ?
            SearchAppBar(
              ...
              mainAppBar: AppBar(
                title: Text(
                language =="en" ? messages_en.getTranslation("News_users_notifications_settings") : messages_ar.getTranslation
                                              ("News_users_notifications_settings"),
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            ...
                                            child: Text(
                                              data[index]["active_notification"].toString(),
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[Padding(
                                            padding: EdgeInsets.only(right: 10.0 , left: 10.0 , top: 0.0) ,
                                            child: Text(
                                               data[index]["notification_type"].toString() ,
