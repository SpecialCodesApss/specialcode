...
import '../../Views/news_newspaper_publishers/view.dart';


class News_newspaper_publishersIndex extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _News_newspaper_publishersIndexState();
  }
}

class _News_newspaper_publishersIndexState extends State<News_newspaper_publishersIndex>{
  ...
  RefreshController _refreshController =
    ...
    void _onRefresh() async {
      ...
      //get list data
            _News_newspaper_publisherController.index(1,searchText).whenComplete((){
              if(_News_newspaper_publisherController.status == true){
                setState(() {
                  data = _News_newspaper_publisherController.listData;
                  if(data.length > 0){
                    isNoListData=false;
                    pagesCount = _News_newspaper_publisherController.data["data"]["last_page"];
                  }
                });
              }else{
    ...
    void _onLoading() async {
      ...
      if (mounted)
        _News_newspaper_publisherController.index(newPage,searchText).whenComplete((){
          if(_News_newspaper_publisherController.status == true){
            setState(() {
              data.addAll(_News_newspaper_publisherController.listData);
              newPage++;
            });
          }
          else{
                      ...
                      child:InkWell(
                        onTap: () {
                          Navigator.of(context).push(
                              MaterialPageRoute(builder: (context) => News_newspaper_publishersView(data[index]["id"]))
                          );
                        },
                        child: GridTile(
                          child: new Card(
                                    ...
                                    child:  Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            data[index]["newspaper_name_ar"].toString(),
                                            style: Theme.of(context).textTheme.body1,
