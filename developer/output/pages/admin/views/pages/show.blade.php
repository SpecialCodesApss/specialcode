...
<div>{{$Page->title_en}}</div>                        </div>
             ...
             <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                            <strong>{{trans("pages.created_at")}}  {{trans("admin.date")}} :</strong>
                     ...
                     <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                            <strong>{{trans("pages.created_at")}}   {{trans("admin.time")}}  :</strong>
             ...
             <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                            <strong>{{trans("pages.updated_at")}}  {{trans("admin.date")}} :</strong>
                     ...
                     <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                            <strong>{{trans("pages.updated_at")}}   {{trans("admin.time")}}  :</strong>
