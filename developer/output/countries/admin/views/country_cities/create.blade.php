...
@section('content')
    ...
    {!! Form::open(array('enctype'=>'multipart/form-data','route' => 'country_cities.store','method'=>'POST')) !!}
    ...
    <div class="row">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name_ar', "", array('placeholder' => trans("country_cities.name_ar"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name_en', "", array('placeholder' => trans("country_cities.name_en"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('slug', "", array('placeholder' => trans("country_cities.slug"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::number('sort',$sort_number, array('placeholder' => trans("country_cities.sort"),'class' => 'form-control')) !!}
                            </div>
                        </div>
