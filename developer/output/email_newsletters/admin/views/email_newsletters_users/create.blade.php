...
@section('content')
    ...
    {!! Form::open(array('enctype'=>'multipart/form-data','route' => 'email_newsletters_users.store','method'=>'POST')) !!}
    ...
    <div class="row">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('email', "", array('placeholder' => trans("email_newsletters_users.email"),'class' => 'form-control')) !!}
                        </div>
                    </div>
