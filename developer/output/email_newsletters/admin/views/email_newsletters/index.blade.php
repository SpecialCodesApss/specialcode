        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-left">
                        <a class="btn btn-success" href="{{ route('email_newsletters.create') }}"> إضافة جديد </a>
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("email_newsletters.id")}}</th>
                          <th class="is_filter">{{trans("email_newsletters.email_title")}}</th>
            ...
            {extend:'csvHtml5',text:'تصدير CSV',
             ...
             {extend:'print',text:'طباعة' ,
                                ...
                                ajax: "{{ route('email_newsletters.index') }}",
                                aoColumns: [
                                    {data: 'id', name: 'id'},
