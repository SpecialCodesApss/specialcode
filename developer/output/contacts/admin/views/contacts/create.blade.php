...
<div class="pcoded-inner-content">
    ...
    {!! Form::open(array('enctype'=>'multipart/form-data','route' => 'contacts.store',
    'method'=>'POST',
    'id'=>'form')) !!}
    ...
    <div class="row">
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('flag', "", array('placeholder' => trans("contacts.flag"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name_ar', "", array('placeholder' => trans("contacts.name_ar"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name_en', "", array('placeholder' => trans("contacts.name_en"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('icon_text', "", array('placeholder' => trans("contacts.icon_text"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                ...
                {{trans('admin.Upload')}}
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('value_ar', "", array('placeholder' => trans("contacts.value_ar"),'class' => 'form-control')) !!}
                        </div>
                    </div>
                 ...
                 <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('value_en', "", array('placeholder' => trans("contacts.value_en"),'class' => 'form-control')) !!}
                        </div>
                    </div>
