        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-left">
                        <a class="btn btn-success" href="{{ route('companies_categories.create') }}"> إضافة جديد </a>
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("companies_categories.id")}}</th>
                          <th class="is_filter">{{trans("companies_categories.parent_category_id")}}</th>
                          <th class="is_filter">{{trans("companies_categories.slug")}}</th>
                          <th class="is_filter">{{trans("companies_categories.name_ar")}}</th>
                          <th class="is_filter">{{trans("companies_categories.category_image")}}</th>
                          <th class="is_filter">{{trans("companies_categories.active")}}</th>
            ...
            {extend:'csvHtml5',text:'تصدير CSV',
             ...
             {extend:'print',text:'طباعة' ,
                                ...
                                ajax: "{{ route('companies_categories.index') }}",
                                aoColumns: [
                                    {data: 'id', name: 'id'},
