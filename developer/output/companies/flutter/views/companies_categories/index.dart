import '../../Controllers/Companies_categorieController.dart';
import 'package:flutter/cupertino.dart';
import '../../helpers/LoaderDialog.dart';
import '../../helpers/ToastHelper.dart';
import 'package:framework_01_6/helpers/LanguageHelper.dart' as LanguageHelper;
import '../../lang/ar/companies_categories.dart' as messages_ar;
import '../../lang/en/companies_categories.dart' as messages_en;
import '../../main.dart';
...
class Companies_categoriesIndex extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _Companies_categoriesIndexState();
  }
}

class _Companies_categoriesIndexState extends State<Companies_categoriesIndex>{
  ...
  String viewType = "ListView";
    ...
    int pagesCount = 1 ;
    int newPage = 2;
  Companies_categorieController _Companies_categorieController = new Companies_categorieController();
  ...
  RefreshController _refreshController =
    ...
    void _onRefresh() async {
      ...
      //get list data
            _Companies_categorieController.index(1,searchText).whenComplete((){
              if(_Companies_categorieController.status == true){
                setState(() {
                  data = _Companies_categorieController.listData;
                  if(data.length > 0){
                    isNoListData=false;
                    pagesCount = _Companies_categorieController.data["data"]["last_page"];
                  }
                });
              }else{
                ShowToast("warning",_Companies_categorieController.message);
              }
            });
    ...
    void _onLoading() async {
      ...
      if (mounted)
        _Companies_categorieController.index(newPage,searchText).whenComplete((){
          if(_Companies_categorieController.status == true){
            setState(() {
              data.addAll(_Companies_categorieController.listData);
              newPage++;
            });
          }
          else{
  ...
  Widget build(BuildContext context) {
    ...
    //           mainAppBar: AppBar(
    //             title: Text(
    //             language =="en" ? messages_en.getTranslation("Companies_categories") : messages_ar.getTranslation
