        ...
        <div class="col_page_content">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right">
                        <h5>علامات الأخبار</h5>
                    </div>
                    <div class="pull-left">
                        <a class="btn btn-success" href="{{ route('news_types_tags.create') }}"> إضافة جديد </a>
                    </div>
                </div>
                <div class="col-md-12" >
                        ...
                        <div class="blog_tablesearch">
                            <div class="table-responsive">
                                <table  id="example" class="table table-striped table-bordered display nowrap dataTable " style="width:100%">
                                    <thead>
                                    <tr>
                                        <th class="is_filter">{{trans("news_types_tags.id")}}</th>
                          <th class="is_filter">{{trans("news_types_tags.slug")}}</th>
                          <th class="is_filter">{{trans("news_types_tags.name_ar")}}</th>
                          <th class="is_filter">{{trans("news_types_tags.name_en")}}</th>
                          <th class="is_filter">{{trans("news_types_tags.active")}}</th>
            ...
            {extend:'csvHtml5',text:'تصدير CSV',
             ...
             {extend:'print',text:'طباعة' ,
                                ...
                                ajax: "{{ route('news_types_tags.index') }}",
                                aoColumns: [
                                    {data: 'id', name: 'id'},
                    {data: 'slug', name: 'slug'},
