...
class EventController {
  ...
  Future<String> index(int page,String searchText) async {
    String request_URL = serverUrl+"/api/events?page=$page&searchText=$searchText";
  ...
  store(String name_ar,String name_en,String description_html_ar,String description_html_en,String city,File image,String date,String website,String active) async {
    //basic variables
    String request_URL = serverUrl+"/api/events";
    final prefs = await SharedPreferences.getInstance();
    var token = prefs.get('token') ?? '0';
    var Lang = prefs.get('lang') ?? 'ar';
  ...
  update(int id,String name_ar,String name_en,String description_html_ar,String description_html_en,String city,File image,String date,String website,String active) async {
    //basic variables
    String request_URL = serverUrl+"/api/events/$id?_method=PUT";
    final prefs = await SharedPreferences.getInstance();
    var token = prefs.get('token') ?? '0';
    var Lang = prefs.get('lang') ?? 'ar';
  ...
  view(int id) async {
    //basic variables
    String request_URL = serverUrl+"/api/events/$id";
    final prefs = await SharedPreferences.getInstance();
    var token = prefs.get('token') ?? '0';
    var Lang = prefs.get('lang') ?? 'ar';
