...
class ForgotPasswordController {
  ...
  SendMobileResetCode(String mobile, context) async {
    //basic variables
    String request_URL = serverUrl + "/api/SendMobileResetCode/" + mobile;
  ...
  SendEmailResetCode(String email, context) async {
    //basic variables
    String request_URL = serverUrl + "/api/SendEmailResetCode/" + email;
    final response = await http.get(request_URL, headers: {
      'Accept': 'application/json',
      'language': language,
    });
  ...
  CheckResetCode(String email, String mobile, String Resetcode, context) async {
    //basic variables
    String request_URL = serverUrl + "/api/CheckResetCode";
  ...
  ResetPassword(
    ...
    //basic variables
    String request_URL = serverUrl + "/api/ResetPassword";
    if (mobile.isNotEmpty) {
      final response = await http.post(request_URL, headers: {
        'Accept': 'application/json',
        'language': language,
